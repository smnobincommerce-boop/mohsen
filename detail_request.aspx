<%@ Page Title="" ValidateRequest="false" Language="C#" MasterPageFile="~/panel/maneger/master_users.Master" AutoEventWireup="true" CodeBehind="detail_request.aspx.cs" Inherits="WebApplicationImpora2222025.panel.maneger.detail_request" %>
            ...
            <div class="blog-posts">
                    ...
                    <div class="col-md-12">
                        <div class="post-media post-comments margin-top-30">
                            ...
                            <div class="media">
                                ...
                                <asp:listview id="ListView_message_request" runat="server">
                ...
                <ItemTemplate>
                       ...
                       <a href="#" class="pull-right">
                                    ...
                                    <img id="img_user_request" runat="server" src='<%# Eval("Pic") %>' alt="" class="media-object img-circle padding-15 " style="width: 80px; height: 100%">
                                </a>
                            ...
                            <div class="form-group">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail">
                                        ...
                                        <asp:fileupload cssclass=" width-200" id="file_upload_request" runat="server" />
                                    </div>
