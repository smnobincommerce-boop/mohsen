<%@ Page Title="" Language="C#" MasterPageFile="~/base.Master" AutoEventWireup="true" CodeBehind="Registering-an-imported-car-with-a-national-code.aspx.cs" Inherits="WebApplicationImpora2222025.Registering_an_imported_car_with_a_national_code" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <meta name="description" content="راهنمای جامع ثبت نام خودروهای وارداتی با کد ملی، شامل شرایط، مدارک لازم، مراحل ثبت نام و نکات مهم">
    <meta name="keywords" content="ثبت نام خودرو وارداتی, خرید خودرو با کد ملی, مراحل ثبت نام خودرو">
    <meta name="author" content="محسن سلیمانی">
    <title>ثبت نام خودروهای وارداتی با کد ملی</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <h2 id="head_estelam" runat="server">درخواست خدمات طراحی معماری</h2>
                    <div>
                        <div class="row">
    ...
    <section class="container-fluid container-fullw bg-white" dir="rtl" id="panelc" style="display: none">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3 ">
                    <h2 id="head_estelam2" runat="server">درخواست خدمات طراحی معماری</h2>
                    <div>
                        <div class="row">
                            <div class="form-group">
                                <div class="col-md-6 ">
