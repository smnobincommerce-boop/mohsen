...
namespace WebApplicationImpora2222025
{
    public partial class index : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.Title = "نوبین | واردات بدون واسطه | تأمین و ترخیص کالا از سراسر جهان";
            Page.MetaDescription = "نوبین، سامانه تخصصی واردات و تأمین کالا، ارائه‌دهنده خدمات واردات بدون واسطه، ترخیص گمرکی و مشاوره تخصصی. با نوبین، کالاهای موردنیاز خود را از معتبرترین تأمین‌کنندگان جهانی با بهترین قیمت و در کمترین زمان دریافت کنید.";
