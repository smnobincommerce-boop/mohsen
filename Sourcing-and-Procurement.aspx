<%@ Page Title="" Language="C#" MasterPageFile="~/base.Master" AutoEventWireup="true" CodeBehind="Sourcing-and-Procurement.aspx.cs" Inherits="WebApplicationImpora2222025.Sourcing_and_Procurement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <meta http-equiv="content-language" content="fa" />
    <meta property="article:modified_time" content="<%= date_last_edit %>" /> <link rel="canonical" href="<%=canonical_url%>" />
