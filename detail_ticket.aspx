<%@ Page Title="" ValidateRequest="false" Language="C#" MasterPageFile="~/panel/maneger/master_users.Master" AutoEventWireup="true" CodeBehind="detail_ticket.aspx.cs" Inherits="WebApplicationImpora2222025.panel.maneger.detail_ticket" %>
            ...
            <div class="">
                <div>
                    ...
                    <div class="inline-block">
                        ...
                        <i class="fa fa-user"></i><span id="txt_name_user" runat="server" class="block week-day text-extra-large">Wensdey</span><asp:HyperLink ID="hbl_info"  runat="server"> <i class="fa fa-info-circle"></i> </asp:HyperLink><br />
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="post-media post-comments margin-top-30">
                            ...
                            <div class="media">
                                ...
                                <asp:ListView ID="ListView_message_ticket" runat="server">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <a href="#" class="pull-right">
                                            ...
                                            <img id="img_user_ticket" runat="server" src='<%# Eval("Pic") %>' alt="" class="media-object img-circle padding-15 " style="width: 80px; height: 100%">
                                        </a>
                                        <div class="media-body">
                                            <h5 class="media-heading" id="name_user_ticket" runat="server"><%# Eval("Name") %> </h5>
                                            <h5 class="media-heading" visible='<%# Eval("Role_visible") %>' id="role_user_ticket" runat="server" style="color: #0000FF"><%# Eval("Role") %> </h5>
                            ...
                            <div class="form-group">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail">
                                        ...
                                        <asp:FileUpload CssClass=" width-200" ID="file_upload_ticket" runat="server" />
                                    </div>
