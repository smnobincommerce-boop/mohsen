<%@ Page Title="" ValidateRequest="false" Language="C#" MasterPageFile="~/panel/maneger/master_users.Master" AutoEventWireup="true" CodeBehind="detail_comment.aspx.cs" Inherits="WebApplicationImpora2222025.panel.maneger.detail_comment" %>
    ...
    <section class="container-fluid container-fullw bg-white">
        ...
        <div class=" panel-dark padding-20">
            <div class="">
                <div>
                    ...
                    <div class="inline-block">
                        ...
                        <i class="fa fa-star"></i><span id="txt_phone_want_contact" runat="server" class="block week-day text-extra-large">Wensdey</span><br />

                        <i class="fa fa-user"></i><span id="txt_name_user" runat="server" class="block week-day text-extra-large">Wensdey</span><br />
                    </div>
                </div>
            </div>
            ...
            <div class="readmore">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a href="#new_comment" class="btn btn-dark-yellow">پاسخ<i class="fa fa-pencil"></i>
                        </a>
                    </div>
                    <div class="col-md-6">
                        <br />
                        ...
                        <div class="post-media post-comments margin-top-30">
                            ...
                            <div class="media">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                <asp:ListView ID="ListView_message_comment" runat="server" OnItemCommand="ListView_message_comment_ItemCommand">
                                    ...
                                    <ItemTemplate>
                                        <div class="pull-left">
                                            <%--<asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/img/delete_icon.png" Height="20" Width="20" ImageAlign="Middle" CommandName="delete" ToolTip="حذف" />--%>
                                            <asp:LinkButton ID="ImageButton1" Visible='<%# Eval("show_item") %>' runat="server" CommandName="delete" ToolTip="حذف"><img src="../../img/delete_icon.png" style="height:20px; width:20px;"/></asp:LinkButton>
                                        </div>
                                         <asp:Label ID="idLabel" runat="server" Text='<%# Eval("id") %>' Visible="false" ForeColor="#F7F6F3"></asp:Label>
                                        <a href="#" class="pull-right">

                                            <img id="img_user_comment" runat="server" src='<%# Eval("Pic") %>' alt="" class="media-object img-circle padding-15 " style="width: 80px; height: 100%">
                                        </a>
                                        <div class="media-body">
                                            <h5 class="media-heading" id="name_user_comment" runat="server"><%# Eval("Name") %> </h5>
                                            <h5 class="media-heading" visible='<%# Eval("Role_visible") %>' id="role_user_comment" runat="server" style="color: #0000FF"><%# Eval("Role") %> </h5>
        ...
        <div id="new_comment">
            <div role="form">
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea id="txt_message_comment" runat="server" class="form-control" cols="20" rows="5" style="width: 100%; height: 200px;" maxlength="1000"></textarea>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_message_comment" CssClass="btn-block" ErrorMessage="متن مورد نياز است" ForeColor="Red" ToolTip="متن مورد نياز است" ValidationGroup="comment"></asp:RequiredFieldValidator>
                            </div>
                            <%-- <div class="form-group">
                                <label>
                                    بارگذاری فایل
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail">
                                        <asp:FileUpload CssClass=" width-200" ID="file_upload_comment" runat="server" />
                                    </div>
                                </div>
                            </div>--%>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <asp:Button CssClass="btn btn-primary " ID="Button_send" runat="server" Text="منتشر شود و پاسخ ثبت شود" OnClick="Button_send_Click"></asp:Button>
                        </div>
                        <div class="col-md-4">
                            <asp:Button CssClass="btn  btn-danger " ID="Button1" runat="server" Text="منتشر نشود" OnClick="Button1_Click"></asp:Button>
                        </div>
                        <div class="col-md-4">
                            <asp:Button CssClass="btn btn-success " ID="Button2" runat="server" Text="منتشر شود" OnClick="Button2_Click"></asp:Button>
                        </div>
                    </div>
                </fieldset>
            </div>
