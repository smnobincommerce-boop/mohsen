<%@ Page Title="" Language="C#" MasterPageFile="~/base.Master" AutoEventWireup="true" CodeBehind="Obtaining-a-Commercial-Card.aspx.cs" Inherits="WebApplicationImpora2222025.Obtaining_a_Commercial_Card" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <meta property="og:title" itemprop="headline" content="اخذ کارت بازرگانی | راهنمای کامل Nobin Commerce" />
    <meta property="og:type" content="article" />
    <meta property="og:description" content="کارت بازرگانی، مجوز اصلی برای صادرات، واردات و تجارت جهانی است. در این راهنما با شرایط، مدارک، مراحل و نکات کلیدی اخذ کارت بازرگانی آشنا شوید." />
    ...
    <meta property="article:section" content="کارت بازرگانی" />
    <meta property="og:url" content="<%= Request.Url %>" />
    <meta property="og:image" content="<%=pic_url%>" />
    <meta property="og:image:alt" content="اخذ کارت بازرگانی - Nobin Commerce" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@Imporaa" />
    <meta name="twitter:title" content="اخذ کارت بازرگانی | Nobin Commerce" />
    <meta name="twitter:description" content="راهنمای جامع کارت بازرگانی؛ شرایط، مدارک و مراحل صدور و تمدید." />
    <meta name="twitter:creator" content="@Imporaa" />
    <meta name="twitter:image:src" content="<%=pic_url%>" />
    <meta name="twitter:image:alt" content="نوبین - خدمات تخصصی کارت بازرگانی و ترخیص کالا" />
    ...
    <script type="application/ld+json">
{
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "http://www.nobincommerce.com/business-card"
  },
  "headline": "اخذ کارت بازرگانی | راهنمای جامع ورود به تجارت جهانی",
  "description": "راهنمای کامل اخذ کارت بازرگانی برای اشخاص حقیقی و حقوقی؛ شامل مدارک مورد نیاز، مراحل اجرایی در سامانه‌های دولتی (جامع تجارت، عدل ایران، گیکا و ...)، نکات مهم قانونی و خدمات تخصصی نوبین گستر پایا برای صدور سریع و مطمئن کارت.",
  "author": {
    "@type": "Organization",
    ...
    <script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "کارت بازرگانی چیست و چه کاربردی دارد؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "کارت بازرگانی مجوز رسمی فعالیت در حوزه صادرات و واردات است که توسط اتاق بازرگانی صادر و به تأیید وزارت صمت می‌رسد. بدون این کارت، انجام ثبت سفارش، تخصیص ارز و ترخیص کالا امکان‌پذیر نیست."
      }
    },
    {
      "@type": "Question",
      "name": "انواع کارت بازرگانی کدامند؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "کارت بازرگانی در دو نوع صادر می‌شود: ۱ ساله برای متقاضیان جدید و ۲ تا ۵ ساله برای اشخاص یا شرکت‌هایی که پروانه بهره‌برداری معتبر از وزارتخانه‌های تولیدی دارند."
      }
    },
    {
      "@type": "Question",
      "name": "مدارک لازم برای اخذ کارت بازرگانی حقیقی چیست؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "مدارک هویتی، کارت پایان خدمت یا معافیت، مدارک تحصیلی، کد مالیاتی، اظهارنامه دفاتر تجاری، توکن امضای الکترونیک، گواهی عدم سوء پیشینه، تصویر پرسنلی و اطلاعات بانکی از مدارک ضروری برای اشخاص حقیقی هستند."
      }
    },
    {
      "@type": "Question",
      "name": "مدارک لازم برای کارت بازرگانی شرکت‌ها چیست؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "برای اشخاص حقوقی، علاوه بر مدارک هویتی مدیران، باید اساسنامه شرکت، روزنامه رسمی تأسیس و تغییرات، اظهارنامه‌های مالیاتی، لیست بیمه‌شدگان، کد اقتصادی، امضای مدیرعامل و اطلاعات بانکی شرکت ارائه شود."
      }
    },
    {
      "@type": "Question",
      "name": "مراحل اجرایی اخذ کارت بازرگانی چگونه است؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "این فرآیند به صورت الکترونیکی و از طریق چند سامانه انجام می‌شود: سامانه ثبت اسناد (پلمپ دفاتر)، سامانه عدل ایران (گواهی عدم سوء پیشینه)، سامانه گیکا (امضای الکترونیک)، سامانه جامع تجارت (ثبت درخواست) و درگاه ملی مجوزها."
      }
    },
    {
      "@type": "Question",
      "name": "آیا اجاره کارت بازرگانی قانونی است؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "خیر. اجاره یا واگذاری کارت بازرگانی جرم محسوب می‌شود و می‌تواند منجر به بدهی‌های مالیاتی سنگین، پرونده‌های قضایی و حتی حکم حبس برای صاحب کارت شود."
      }
    },
    {
      "@type": "Question",
      "name": "چقدر زمان برای صدور کارت بازرگانی لازم است؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "برای متقاضیان بار اول، صدور کارت به طور میانگین ۲ تا ۳ ماه زمان می‌برد. تمدید کارت معمولاً در صورت نبود تغییرات، بین ۲ تا ۳ هفته انجام می‌شود."
      }
    },
    {
      "@type": "Question",
      "name": "چرا باید از خدمات نوبین گستر پایا برای اخذ کارت بازرگانی استفاده کنیم؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "زیرا این شرکت با تجربه بالا در امور بازرگانی، صفر تا صد فرآیند را شام
