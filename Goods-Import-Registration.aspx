<%@ Page Title="" Language="C#" MasterPageFile="~/base.Master" AutoEventWireup="true" CodeBehind="Goods-Import-Registration.aspx.cs" Inherits="WebApplicationImpora2222025.Goods_Import_Registration" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <meta name="genre" itemprop="genre" content="Imports, Trade" />
    ...
    <meta property="og:title" itemprop="headline" content="ثبت سفارش کالا | Goods Import Registration" />
    ...
    <meta property="article:section" content="ثبت سفارش کالا" />
    <meta property="og:url" content="<%= Request.Url %>" />
    <meta property="og:image" content="<%=pic_url%>" />
    <meta property="og:image:alt" content="ثبت سفارش کالا" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@Imporaa" />
    <meta name="twitter:title" content="ثبت سفارش کالا | Goods Import Registration" />
    <meta name="twitter:description" content="<%= Page.MetaDescription %>" />
    <meta name="twitter:creator" content="@Imporaa" />
    <meta name="twitter:image:src" content="<%=pic_url%>" />
    <meta name="twitter:image:alt" content="ثبت سفارش کالا - خدمات تخصصی نوبین" />
    ...
    <script type="application/ld+json">
{
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "http://www.nobincommerce.com/product-registration-guide"
  },
  "headline": "راهنمای جامع ثبت سفارش کالا در سامانه جامع تجارت | مراحل و نکات کلیدی",
  "description": "این راهنما تمامی مراحل ثبت سفارش کالا در سامانه جامع تجارت (NTSW) را توضیح می‌دهد؛ از اهمیت ثبت سفارش و پیش‌نیازها (کارت بازرگانی، امضای الکترونیک، پروفرما) تا مراحل گام‌به‌گام دریافت کد ۸ رقمی، اشتباهات رایج و خدمات تخصصی شرکت نوبین گستر پایا.",
  "author": {
    "@type": "Organization",
